...
<body>
	...
	<div class="container">
		<div class="subheader">
			...
			<p class="caption">Below are the stakeholders that participate in this project.</p>
		</div>
		<div class="content">
			<p class="caption" id="noStakeholder" style="text-align: center;">No stakeholder yet...</span></p>
		</div>
		...
		<div class="empty">
			<p class="caption" id="noStakeholderSearch" style="text-align: center;">No stakeholder found...</p>
		</div>
	</div>
